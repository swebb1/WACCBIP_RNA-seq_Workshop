...
For a quick refresh of linux commands take a look [here](https://files.fosswire.com/2007/08/fwunixref.pdf).
...
If you are new to RNA-seq, this 
[overview](https://hbctraining.github.io/Intro-to-rnaseq-hpc-salmon-flipped/lessons/01_intro-to-RNAseq.html) provides an explanation of how RNA-seq libraries are prepared and sequenced for short-read data.
...
<img src="images/splice_mapping.png" width=700>
...
Open IGV and set the genome to **hg38**, then find your *visualisation* folder online.
...
<img src="images/igv_genome.png" width=1200>
...
5. Select multiple tracks and set the scale to **Group autoscale**. This will automatically scale tracks together.
...
<img src="images/MOV10.png" width=1200>
...
<img src="images/igv_bam.png" width=1200>
...
<img src="images/sashimi.png" width=1200>
