...
Once complete, take a look at the output images in your browser via RStudio. This shows that most of your reads align to the human genome and that no reads align uniquely to other organisms:
...
![pic](images/multi.png){alt="pic" width="600"}
